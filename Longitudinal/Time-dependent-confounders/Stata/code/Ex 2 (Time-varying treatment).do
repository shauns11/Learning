...
keep id outcome treat time sex x
save "${data_a}/ipw_Ex2a_R.dta", replace
...
use "${Git_data}/ipw_Ex2b.dta", clear
*use "C:\Users\rmjdshc\OneDrive - University College London\Learning\Longitudinal\01. IPTW\data\ipw_Ex2b.dta", clear
...
keep id y treat time male age v
save "${data_a}/ipw_Ex2b_R.dta", replace
