...
*save "C:\Users\rmjdshc\OneDrive - University College London\Learning\Longitudinal\01. IPTW\data\ipw_Ex3b.dta", replace
...
keep id time treat x x_0 sex cens y drop_tx
*Data in long form
save "${data_a}/ipw_Ex3a_R.dta", replace
...
use "${Git_data}/ipw_Ex3b.dta", clear
*use "${data}/ipw_Ex3b.dta", clear
...
keep id outcome treat x dropout time dropTx  drop_c
save "${data_a}/ipw_Ex3b_R.dta", replace
